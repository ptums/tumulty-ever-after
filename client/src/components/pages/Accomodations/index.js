     ...
     <div className="col-lg-12 col-sm-12 col-md-12">
        <div className="card mt-4">
          <div className="card-body text-center">
            ...
            <p className="card-text"><strong>*Booking Online:</strong> We recommend you use this direct link which will take you to our group’s designated booking page. If you end up going through the hotel’s general reservation page you can enter Group Code <strong>“CTMCTMB”</strong> for a room with two beds OR Group Code <strong>“CTMCTMA”</strong> for a room with one bed.</p>
          </div>
        </div>
     </div>
    </div>
